...
namespace DemoMVC.Controllers
{
    ...
    public class AttendanceController(ApplicationDbContext context) : Controller
    {
        ...
        [Route("diem-danh/{sessionId}")]
        public async Task<IActionResult> Mark(AttendanceVM model, int sessionId)
        {
            ...
            return RedirectToAction("Mark", "Attendance", new { sessionId = model.SessionId });
        }
    }
}